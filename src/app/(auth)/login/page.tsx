      ...
      <div className="w-full max-w-md space-y-8 glass-panel rounded-2xl p-8 shadow-2xl relative z-10">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            Sign in to your AI thinking companion
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-lg border border-indigo-500/30 hover:border-indigo-400 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 text-sm font-semibold transition-all shadow-md cursor-pointer disabled:opacity-50"
          >
            Explore in Demo Mode (No Setup Required)
          </button>
        </form>
